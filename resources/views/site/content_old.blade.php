  ...
  <div class="container">
    <div  class="two-thirds column msg"><br>
      {{-- <h4>Написать сообщение</h4> --}}
        ...
        <!-- Give href an ID value of corresponding "tabs-content" <li>'s -->
          <li><a class="active" href="#firstab-1">Написать сообщение</a></li>
            <li><a href="#firstab-2">Заказать обратный звонок</a></li>
        </ul>
    ...
    <div  class="one-third column contacts-r">
      <ul class="add-bottom_2">
        ...
        <li>пос.Заостровье
	<li>&nbsp;</li>
        <li style="font-size:16px;font-weight:700;"><a href="tel:+79062370031">+7 906 237 00 31</a></li>
	<li>&nbsp;</li>
